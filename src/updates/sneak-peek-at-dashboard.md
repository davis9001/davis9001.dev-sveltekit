---
title: "Sneak Peek at Dashboard: A Personal Web Dashboard Project"
description: "A first look at Dashboard, a personal productivity hub built under the *Space GitHub organization with weather, traffic, GitHub integration, and more."
publishedAt: 2026-03-13T04:00:00Z
summary: "An early preview of Dashboard—a personal productivity hub with weather, traffic maps, GitHub project tracking, and a calendar, all in one place."
tags: [dashboard, web-development, starspace, side-project, productivity, open-source]
---

One of the newer projects under the [*Space](https://starspace.group/) GitHub organization is something I've been wanting for a while: a personal web dashboard that brings together the widgets and data I reach for every day into one clean, authenticated hub.

It's called **Dashboard**, and here's an early look at it in action:

<img src="/dashboard-sneak-peek.webp" alt="Animated preview of the Dashboard project interface" style="width:100%;max-width:1200px;border-radius:8px;" />

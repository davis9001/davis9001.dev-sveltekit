/**
 * Canonical content hashing for predictions — computed once at first
...
export interface CanonicalPredictionContent {
	title: string;
	slug: string;
	body: string;
...
export async function computeCanonicalHash(input: CanonicalPredictionContent): Promise<string> {

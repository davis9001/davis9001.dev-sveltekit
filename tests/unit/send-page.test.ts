  ...
  describe('Send Page UI', () => {
    it('should display the page heading and subtitle', async () => {
      ...
      const { getByText } = render(SendPage.default, {
        props: {
          data: { user: null, hasAIProviders: false, portfolioItems: [], blogPosts: [], openProjects: [], hasAuthConfig: false },
          form: null
        }
      });
    ...
    it('should display user info when logged in', async () => {
      ...
      const { container, getByText } = render(SendPage.default, {
        props: {
          data: { user: mockUser, hasAIProviders: false, portfolioItems: [], blogPosts: [], openProjects: [], hasAuthConfig: false },
          form: null
        }
      });

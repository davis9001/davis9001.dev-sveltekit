...
describe('Admin AI Keys Page', () => {
	...
	it('should render the page title', () => {
		render(AIKeysPage, { props: { data: { user: mockUser, hasAIProviders: false, portfolioItems: [], cmsPaletteItems: [], openProjects: [], hasAuthConfig: false, keys: [] } } });
	...
	it('should render a list of existing AI keys', () => {
		...
		render(AIKeysPage, { props: { data: { user: mockUser, hasAIProviders: false, portfolioItems: [], cmsPaletteItems: [], openProjects: [], hasAuthConfig: false, keys: mockKeys } } });

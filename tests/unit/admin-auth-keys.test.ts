...
describe('Admin Auth Keys Page', () => {
	...
	it('should render the page title', () => {
		render(AuthKeysPage, { props: { data: { user: mockUser, hasAIProviders: false, portfolioItems: [], blogPosts: [], openProjects: [], hasAuthConfig: false, keys: [] } } });
	...
	it('should render a list of existing keys', () => {
		...
		render(AuthKeysPage, {
			props: { data: { user: mockUser, hasAIProviders: false, portfolioItems: [], blogPosts: [], openProjects: [], hasAuthConfig: false, keys: mockKeys } }
		});
